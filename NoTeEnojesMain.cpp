...
int main()
{
    ...
    for(r=0;r<1000000;r++)
    {
        ...
        {
            //red turn
            if(randomStart == 1) //if randomStart is 1, blue goes first
            {
                turnDone = 1;
                randomStart = 0;
            }
            ...
            if(redPlayer.win == 1 && bluePlayer.win == 1)
                ties++;
            if(win == 1)
                break;
            sixCounter = 0;
    ...
    cout << "blue starts: " << counter.blueStarts << endl;
    cout << "red caps: " << counter.redCaps << endl;
    cout << "red wins: " << counter.redWins << endl;
    cout << "red starts: " << counter.redStarts << endl;
